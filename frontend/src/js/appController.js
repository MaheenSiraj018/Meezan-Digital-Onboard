define([
  ...
  function ControllerViewModel() {
    ...
    let navData = [
      ...
      //remove this
      // {
      //   path: "individual-comp",detail: { label: "Individual Comp", iconClass: "oj-ux-ico-contact" },
...
//     let navData = [
//       { path: "", redirect: "account" }, // redirect root → profile
//       {
//         path: "account",
//         detail: { label: "My Account", iconClass: "oj-ux-ico-person" },
//       },
//       {
//         path: "accountdetails",
//         detail: { label: "My Account Details", iconClass: "oj-ux-ico-person" },
//       },
//     ];
